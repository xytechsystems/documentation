...
Additionally, there are sub-sections of related tables with their key fields. Lookups (GET) can only filter sub-tables using the sub-table primary key and not their alternate keys, unless sub-table fields exist in the main body of the payload.
